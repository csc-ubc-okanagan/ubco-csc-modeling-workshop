This repo contains the `R` scripts used in the modeling workshop offered at UBCO by the CSC (https://events.ok.ubc.ca/event/fitting-models-to-data-not-data-to-models-eight-workshop-series/).
